...
exports.book_list = function(req, res) {
  Book.find({}, "title author")
    ...
    .exec(function(err, list_books) {
      ...
      //Succesful, so render
      res.render("book_list", { title: "Book List", book_list: list_books }); // render the book_list view, along with parameters (title & the actual book_list)
    });
...
exports.book_create_post = [
  ...
  body("summary", "Summary must not be empty.")
    .isLength({ min: 1 })
    .trim(),
  body("isbn", "ISBN mmust not be empty")
    .isLength({ min: 1 })
    .trim(),
